 ...
 */
public abstract class ExpendHeaderBehavior<V extends View> extends ViewOffsetExpendBehavior<V> {
    ...
    public ExpendHeaderBehavior() {
    }

    public ExpendHeaderBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
