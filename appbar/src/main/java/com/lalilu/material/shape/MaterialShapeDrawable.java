...
package com.lalilu.material.shape;
...
import com.lalilu.material.color.MaterialColors;
import com.lalilu.material.elevation.ElevationOverlayProvider;
import com.lalilu.material.shadow.ShadowRenderer;
import com.lalilu.material.shape.ShapePath.ShadowCompatOperation;
...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    public boolean requiresCompatShadow() {
        return VERSION.SDK_INT < VERSION_CODES.LOLLIPOP
                || (!isRoundRect() && !path.isConvex() && VERSION.SDK_INT < VERSION_CODES.Q);
    }
