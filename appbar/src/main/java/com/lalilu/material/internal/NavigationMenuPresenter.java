...
public class NavigationMenuPresenter implements MenuPresenter {
  ...
  /**
   * Handles click events for the menu items. The items has to be {@link com.google.android.material.internal.NavigationMenuItemView}.
   */
  final View.OnClickListener onClickListener =
      new View.OnClickListener() {
        ...
        public void onClick(View view) {
          com.google.android.material.internal.NavigationMenuItemView itemView = (com.google.android.material.internal.NavigationMenuItemView) view;
  ...
  private class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
      switch (getItemViewType(position)) {
        case VIEW_TYPE_NORMAL:
          {
            com.google.android.material.internal.NavigationMenuItemView itemView = (com.google.android.material.internal.NavigationMenuItemView) holder.itemView;
    ...
    public Bundle createInstanceState() {
      ...
      SparseArray<com.google.android.material.internal.ParcelableSparseArray> actionViewStates = new SparseArray<>();
      for (int i = 0, size = items.size(); i < size; i++) {
        ...
        if (navigationMenuItem instanceof NavigationMenuTextItem) {
          ...
          if (actionView != null) {
            com.google.android.material.internal.ParcelableSparseArray container = new com.google.android.material.internal.ParcelableSparseArray();
    ...
    public void restoreInstanceState(@NonNull Bundle state) {
      ...
      SparseArray<com.google.android.material.internal.ParcelableSparseArray> actionViewStates =
