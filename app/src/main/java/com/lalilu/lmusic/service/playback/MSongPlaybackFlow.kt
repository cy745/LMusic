...
import com.lalilu.lmusic.utils.toMediaMetadataCompat
...
class MSongPlaybackFlow @Inject constructor(
    ...
    override val mediaIdFlow: Flow<String?> = dataModule2.mediaId
    override val listFlow: Flow<List<MSong>> = dataModule2.nowPlaylistMetadataFlow
    override val repeatModeFlow: Flow<Int> = dataModule2.repeatModeFlow
    ...
    override fun getPreviousItemFromListByNowID(list: List<MSong>, id: String?): MSong? {
    ...
    override fun getMetaDataFromItem(item: MSong): MediaMetadataCompat {
        return item.toMediaMetadataCompat()
    }
}